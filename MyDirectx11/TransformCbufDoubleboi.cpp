...
namespace Bind
{
	Bind::TransformCbufDoubleboi::TransformCbufDoubleboi(Graphics& gfx, const Drawable& parent, UINT slotV, UINT slotP)
	...
	void Bind::TransformCbufDoubleboi::UpdateBindImpl(Graphics& gfx, const Transforms& tf) noexcept
	{
